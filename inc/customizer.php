...
function sumun_new_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_section('sumun_homepage', array(
        'title'         => __( 'Página de inicio', 'sumun-admin' ),
        'priority'      => 20,
        'panel'         => 'sumun_opciones',
    ));
    $wp_customize->add_section('sumun_post_types', array(
        'title'         => __( 'Tipos de publicaciones', 'sumun-admin' ),
        'priority'      => 20,
        'panel'         => 'sumun_opciones',
    ));
    ...
    foreach ($post_types as $post_type) {
        ...
        $wp_customize->add_setting( $post_type . '-descripcion' );
        $wp_customize->add_control( $post_type . '-descripcion',   array(
            'type'      => 'textarea',
            'label'     => __( 'Descripción para ' . $post_type, 'sumun-admin' ),
            'section'   => 'sumun_post_types',
        ) );

    	$wp_customize->add_setting( $post_type . '-imagen-cabecera' );
		$wp_customize->add_control(
			new WP_Customize_Media_Control(
			   $wp_customize,
			   $post_type . '-imagen-cabecera',
			   array(
			       'label'      => __( 'Imagen de cabecera para ' . $post_type, 'sumun-admin' ),
			       'section'    => 'sumun_post_types',
			   )
			)
		);
	...
	$wp_customize->add_setting( 'aessia-imagen-por-defecto' );
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
		   $wp_customize,
		   'aessia-imagen-por-defecto',
		   array(
		       'label'      => __( 'Imagen por defecto ', 'sumun-admin' ),
