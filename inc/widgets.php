	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				...
				'id'            => 'top-bar',
				'description'   => __( 'Barra en la parte superior de todas las páginas', 'understrap' ),
	    ...
	    register_sidebar(
	        array(
	            'name'          => __( 'Footer Formación', 'understrap' ),
	            'id'            => 'footer-formacion',
	            'description'   => __( 'Aparece tras la descripción de los cursos', 'understrap' ),
		...
		register_sidebar(
			array(
				...
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s col-6 col-md-3">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<p class="widget-title">',
				'after_title'   => '</p>',
			)
		...
		register_sidebar(
			array(
				'name'          => __( 'Pre Copyright Izquierda', 'understrap' ),
				'id'            => 'precopyright-left',
				'description'   => __( 'Aparece antes del Copyright', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<p class="widget-title">',
				'after_title'   => '</p>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Pre Copyright Derecha', 'understrap' ),
				'id'            => 'precopyright-right',
				'description'   => __( 'Aparece antes del Copyright', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<p class="widget-title">',
	    ...
	    register_sidebar(
	        array(
	            'name'          => __( 'Copyright contacto', 'understrap' ),
	            'id'            => 'copyright-contacto',
	            'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
