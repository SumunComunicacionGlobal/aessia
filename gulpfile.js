...
gulp.task('scripts', function() {
	var scripts = [
		...
		// `${paths.dev}/js/bootstrap4/index.js`,
		`${paths.dev}/js/bootstrap4/util.js`,
		// `${paths.dev}/js/bootstrap4/alert.js`,
		// `${paths.dev}/js/bootstrap4/button.js`,
		// `${paths.dev}/js/bootstrap4/carousel.js`,
		`${paths.dev}/js/bootstrap4/collapse.js`,
		`${paths.dev}/js/bootstrap4/dropdown.js`,
		`${paths.dev}/js/bootstrap4/modal.js`,
		// `${paths.dev}/js/bootstrap4/popover.js`,
		// `${paths.dev}/js/bootstrap4/scrollspy.js`,
		`${paths.dev}/js/bootstrap4/tab.js`,
		// `${paths.dev}/js/bootstrap4/toast.js`,
		// `${paths.dev}/js/bootstrap4/tooltip.js`,
